...
As soon as we reach a valid solution that follows all the constraints we return 'true'. This indicates we do not need to continue our search. (This is an important step as otherwise we will get TLE).
